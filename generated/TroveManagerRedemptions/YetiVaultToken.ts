...
export class YetiVaultToken extends ethereum.SmartContract {
  static bind(address: Address): YetiVaultToken {
    return new YetiVaultToken("YetiVaultToken", address);
  }
  ...
  try_deposit(_amt: BigInt): ethereum.CallResult<BigInt> {
  ...
  depositFor(_borrower: Address, _recipient: Address, _amt: BigInt): BigInt {
    let result = super.call(
      "depositFor",
